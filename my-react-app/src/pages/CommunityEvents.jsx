      ...
      <div className='main-container'>
        <div className='container-1'>
          ...
          <div className='note'>
            ...
            <p> The Office of Alumni Relations, Alumni Association and the Endowment Office at IIT Ropar have been organizing reunions for different batches over the years. The institute feels immense pride in welcoming back and hosting alumni again on the campus. Reunions for various batches have been planned in the year 2023-24 at IIT Ropar. We encourage alumni to attend these events and meet fellow batchmates.
                <br/>The Reunions are typically held at New Delhi with an Institute Day at the IIT Ropar Campus. Batches plan the events over a 2-3 day period with fun engagement activities at Campus or Off-Site, plans are customized by each batch as per their preferences.
                ...
                <br/>Office Of Alumni Relations, IIT Ropar
                <br/>Email : alumniaffairs@admin.iitrpr.ac.in
            </p>
          </div>
        </div>
      </div>
