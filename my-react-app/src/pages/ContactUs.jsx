...
const ContactUs = () => {
  ...
  return (
    ...
    <div className="w-full m-2 border-gray-300 p-6 bg-white rounded-md shadow-md justify-center">
      <h2 className="text-2xl font-semibold mb-2 text-center">Call Back Request or Mail to :</h2>
      <h2 className="text-lg font-semibold mb-4 text-center">kavleen6@admin.iitrpr.ac.in</h2>
      {submitted ? (
        ...
        <form onSubmit={handleSubmit}  className="w-full ">
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full px-4 py-2 mb-2 rounded-md border focus:outline-none focus:border-blue-500"
              required
            />
          </div>
          <div className="mb-4">
     ...
     <div className="bg-blue-500 text-white py-8">
        <div className="max-w-4xl mx-auto flex flex-col lg:flex-row items-center justify-center lg:justify-between">
          <div className="lg:w-1/2 mb-4 lg:mb-0">
            ...
            <img
              src="https://example.com/dean-photo.jpg" // Replace with the actual photo URL
              alt="Dean's Photo"
