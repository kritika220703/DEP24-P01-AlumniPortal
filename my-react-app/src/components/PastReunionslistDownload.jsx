...
const PastReunionslistDownload = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
          try {
            const usersRef = collection(db, "pastReunions");
      ...
      const downloadAsPdf = () => {
        ...
        doc.save("pastt_reunions_firebase_data.pdf");
      };
...
export default PastReunionslistDownload