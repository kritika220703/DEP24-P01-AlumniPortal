...
const Gallery = () => {
    // const slides=[
    //     {url:"./../assets/img1.jpg",alt:"image1"},
    //     {url:"./../assets/img2.jpg",alt:"image2"},
    //     {url:"./../assets/img3.jpeg",alt:"image3"},
    //     {url:"./../assets/img4.jpg",alt:"image4"},
    // ];
    ...
    return (
      <div className='max-w-[900px] h-[500px] w-full m-auto py-16 px-4 relative group'>
        <div
