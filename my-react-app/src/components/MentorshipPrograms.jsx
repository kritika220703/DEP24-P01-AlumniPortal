...
const MentorshipProgramsListComponent = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const usersRef = collection(db, "Mentorship Programs");
          ...
          <TableHead>
            <TableRow hover>
              ...
              <StyledTableCell align="right">
                Domain{" "}
                <FilterDropdown
                  options={users.map((user) => user.domain)}
                  columnName="domain"
                />
              </StyledTableCell>
              <StyledTableCell align="right">
                Eligibility{" "}
                <FilterDropdown
                  options={users.map((user) => user.eligibility)}
          ...
          <TableBody>
            {filteredUsers.map((user, index) => (
              <StyledTableRow key={index} hover sx={{ cursor: "pointer" }}>
                ...
                <StyledTableCell align="right">{user.domain}</StyledTableCell>
                <StyledTableCell align="right">{user.eligibility}</StyledTableCell>
...
export default MentorshipProgramsListComponent;
