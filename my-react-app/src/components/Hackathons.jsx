...
const HackathonsListComponent = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const usersRef = collection(db, "Tech Talks and Hackathons");
          ...
          <TableHead>
            <TableRow hover>
              ...
              <StyledTableCell align="right">
                Topic{" "}
                <FilterDropdown
                  options={users.map((user) => user.topic)}
                  columnName="topic"
                />
              </StyledTableCell>
              <StyledTableCell align="right">
...
export default HackathonsListComponent;
